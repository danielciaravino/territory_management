...
with open('myfile_shoffstall.geojson', 'r') as file:
...
fig.update_layout(
    mapbox = {
        ...
        'zoom': 6, 'layers': [{
            'source': geojson_data,
            'type': 'fill','opacity': 0.1,  'below': "traces", 'color': "#E6B0AA"},
            {
            'source': geojson_data_2,
            'type': 'fill','opacity': 0.1,  'below': "traces", 'color': "#A9DFBF"},
            ],
            },
